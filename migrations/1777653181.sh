...
if swarmarchy-hw-dell-xps-haptic-touchpad; then
  ...
  sudo rm -f /etc/swarmarchy-dell-haptic-touchpad.env
  sudo systemctl daemon-reload
  sudo udevadm control --reload-rules

  source "$SWARMARCHY_PATH/install/packaging/dell-xps-touchpad-haptics.sh"
fi
