...
cp "$SWARMARCHY_PATH/config/systemd/user/swayosd-server.service" ~/.config/systemd/user/swayosd-server.service
...
bash "$SWARMARCHY_PATH/install/first-run/swayosd.sh"
