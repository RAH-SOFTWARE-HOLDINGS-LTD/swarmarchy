...
class TranscodeAction(GObject.GObject, Nautilus.MenuProvider):
    def _launch_transcode(self, paths):
        wrapper = shutil.which("swarmarchy-launch-floating-terminal-with-presentation")
        binary = shutil.which("swarmarchy-transcode")
    ...
    def _make_item(self, paths):
        ...
        item = Nautilus.MenuItem(
            name="SwarmarchyTranscodeNautilus::transcode",
            label=label,
    ...
    def _tools_available(self):
        return bool(
            shutil.which("swarmarchy-launch-floating-terminal-with-presentation")
            and shutil.which("swarmarchy-transcode")
        )
