--
-- Dynamic Swarmarchy Theme Menu for Elephant/Walker
--
Name = "swarmarchythemes"
NamePretty = "Swarmarchy Themes"
...
function GetEntries()
  local entries = {}
  local user_theme_dir = os.getenv("HOME") .. "/.config/swarmarchy/themes"
  local swarmarchy_path = os.getenv("SWARMARCHY_PATH") or ""
  local default_theme_dir = swarmarchy_path .. "/themes"
      ...
      if theme_name and not seen_themes[theme_name] then
        ...
        if preview_path and preview_path ~= "" then
          ...
          table.insert(entries, {
            ...
            PreviewType = "file",
            Actions = {
              activate = "swarmarchy-theme-set " .. theme_name,
            },
          })
        end
      end
