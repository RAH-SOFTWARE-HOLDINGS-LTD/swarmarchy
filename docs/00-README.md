...
| 04 | `04-testing-sway.md` | **The tests.** Run them once you have a Sway session |
| 05 | `05-step3-vm-testing.md` | How to build a throwaway aarch64 VM to test in (then run 04) |
